...
namespace VKE.Effects
{
    ...
    {
        public override string Texture => "VKE/Effects/LightningParticle";
        ...
        {
            Texture2D circle = ModContent.Request<Texture2D>("VKE/Effects/Textures/Circle").Value;
            Texture2D glow = ModContent.Request<Texture2D>("VKE/Effects/Textures/SoftGlow").Value;
