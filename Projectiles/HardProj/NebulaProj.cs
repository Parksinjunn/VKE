...
{
    public class NebulaProj : KnifeProjectile, IPixelPrimitiveDrawer
    {
        ...
        public override void Kill(int timeLeft)
        {
            for (int j = 0; j < 5; j++)
            {
                ...
                int dust1 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), (int)Projectile.Size.X, (int)Projectile.Size.Y, DustID.PurpleCrystalShard, Vel.X, Vel.Y, newColor: Color.Violet, Scale: 1.5f);
        ...
        public override void SafeOnHitNPC(NPC n, int damage, float knockback, bool crit)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), new Vector2(n.position.X + n.width, n.position.Y), Projectile.velocity, 634, (int)(Projectile.damage), 4, owner.whoAmI);
        }
    }
}