...
{
    public class StardustProj : KnifeProjectile, IPixelPrimitiveDrawer
    {
        ...
        {
            return Color.Lerp(Color.SkyBlue, Color.Transparent, completionRatio) * 0.7f;
        }
        ...
        public override void SafeOnHitNPC(NPC n, int damage, float knockback, bool crit)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), n.Center, new Vector2(0, 0), ModContent.ProjectileType<StardustProjCell>(), Projectile.damage, 8, owner.whoAmI);
            }
        }
    }
}