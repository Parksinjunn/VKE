...
{
    public class TitaniumProj : AmmoProjectile, IPixelPrimitiveDrawer
    {
        ...
        {
            Color ColorFade = Color.Lerp(new Color(248, 179, 254), new Color(139, 124, 184), Color1Fade);
            return Color.Lerp(ColorFade, new Color(138, 222, 222), completionRatio) * 0.7f;
        }
