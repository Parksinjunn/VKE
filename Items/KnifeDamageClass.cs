...
namespace VKE.Items
{
	public class KnifeDamageClass : DamageClass
	{
        ...
        public override StatInheritanceData GetModifierInheritance(DamageClass damageClass)
        {
            ...
            if (damageClass == DamageClass.Ranged || damageClass == DamageClass.Throwing)
        ...
        public override void SetDefaultStats(Player player)
        {
            ...
            //player.GetCritChance<KnifeDamageClass>() += 4;
            //player.GetArmorPenetration<KnifeDamageClass>() += 10;
            player.GetDamage<KnifeDamageClass>() *= VampKnives.ConfigDamageMult;
