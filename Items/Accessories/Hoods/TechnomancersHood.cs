...
namespace VKE.Items.Accessories.Hoods
{
    ...
    public class TechnomancersHood : ModItem
    {
        public override void Load()
        {
            ...
            EquipLoader.AddEquipTexture(Mod, $"{Texture}_{EquipType.Head}", EquipType.Head, this, equipTexture: new TechnomancerHead());
            //EquipLoader.AddEquipTexture(Mod, $"{Texture}Alt_{EquipType.Head}", EquipType.Head, name: "BlockyAlt", equipTexture: new TechnomancerHead());
        }
