...
namespace VKE.Items.Accessories.Hoods
{
    ...
    public class InvokersHood : ModItem
    {
        public override void Load()
        {
            ...
            EquipLoader.AddEquipTexture(Mod, $"{Texture}_{EquipType.Head}", EquipType.Head, this, equipTexture: new InvokerHead());
            //EquipLoader.AddEquipTexture(Mod, $"{Texture}Alt_{EquipType.Head}", EquipType.Head, name: "BlockyAlt", equipTexture: new InvokerHead());
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.FlaskofIchor, 15);
