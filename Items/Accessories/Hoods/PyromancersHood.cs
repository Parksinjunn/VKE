...
namespace VKE.Items.Accessories.Hoods
{
    ...
    public class PyromancersHood : ModItem
    {
        ...
        public override void Load()
        {
            ...
            // Add equip textures
            EquipLoader.AddEquipTexture(Mod, $"{Texture}_{EquipType.Head}", EquipType.Head, this, equipTexture: new PyroHead());

            //Add a separate set of equip textures by providing a custom name reference instead of an item reference
            //EquipLoader.AddEquipTexture(Mod, $"{Texture}Alt_{EquipType.Head}", EquipType.Head, name: "BlockyAlt", equipTexture: new PyroHead());
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.FlaskofFire , 15);
