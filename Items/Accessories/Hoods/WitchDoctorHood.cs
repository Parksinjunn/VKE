...
namespace VKE.Items.Accessories.Hoods
{
    ...
    public class WitchDoctorHood : ModItem
    {
        public override void Load()
        {
            ...
            // Add equip textures
            EquipLoader.AddEquipTexture(Mod, $"{Texture}_{EquipType.Head}", EquipType.Head, this, equipTexture: new WitchDoctorHead());

            //Add a separate set of equip textures by providing a custom name reference instead of an item reference
            //EquipLoader.AddEquipTexture(Mod, $"{Texture}Alt_{EquipType.Head}", EquipType.Head, name: "BlockyAlt", equipTexture: new WitchDoctorHead());
        }
        ...
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("The power of Voodoo" +
                "\nWho do?" +
